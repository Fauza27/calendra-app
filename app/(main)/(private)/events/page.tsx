...
export default async function EventsPage() {
    ...
    return (
        <section className="flex flex-col items-center gap-16 animate-fade-in">
            ...
            {events.length > 0 ? (
                <div className="grid fap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 p-10">
                    {events.map(event => (
                ...
                <div className="flex flex-col items-center gap-4">
                    ...
                    <Button
                    className="bg-blue-500 hover:bg-blue-400 text-white py-6 hover:scale-110 duration-500 border-b-4 border-blue-700 hover:border-blue-500 rounded-2xl shadow-accent-foreground shadow-2xl font-black" asChild
                    >
                        <Link href="/events/new">
